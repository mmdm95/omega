            ...
            <div class="page-header page-header-default"
                ...
                <div class="page-header-content border-bottom border-bottom-success">
                    <div class="page-title">
                        <h5>
                            ...
                            <span class="text-semibold">روش‌های پرداخت</span>
                        </h5>
                    </div>
                </div>
                <div class="breadcrumb-line">
                    <ul class="breadcrumb">
                        ...
                        <li class="active">روش‌های پرداخت</li>
                    </ul>
                </div>
            </div>
            <!-- /page header -->
                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-white">
                                    <div class="panel-heading">
                                        <h6 class="panel-title">روش‌های پرداخت</h6>
                                            ...
                                            <table class="table table-hover table-bordered datatable-highlight">
                                                ...
                                                <?php foreach ($payments as $key => $payment): ?>
                                                    <tr>
                                                        ...
                                                        <td width="100px">
                                                            <a data-url="<?= base_url() . $payment['image']; ?>"
                                                               data-popup="lightbox">
                                                                <img src=""
                                                                     data-src="<?= base_url() . $payment['image']; ?>"
                                                        ...
                                                        <td style="width: 115px;" class="text-center">
                                                            <ul class="icons-list">
                                                                <li class="text-primary-600">
                                                                    <a href="<?= base_url(); ?>admin/editPayment/<?= $payment['id']; ?>"
                                                                       title="ویرایش" data-popup="tooltip">
                                                                        <i class="icon-pencil7"></i>
                                                                    </a>
                                                                </li>
                                                                <?php if ($payment['deletable'] == 1): ?>
                                                                    <li class="text-danger-600">
                                                                        <a class="deletePaymentBtn"
