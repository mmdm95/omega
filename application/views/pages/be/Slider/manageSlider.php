                    ...
                    <div class="page-title">
                        <h5>
                            <i class="icon-circle position-left"></i> <span
                                class="text-semibold">اسلایدها</span>
                        </h5>
                    </div>
                </div>
                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-white">
                                    <div class="panel-heading">
                                        <h6 class="panel-title">اسلاید‌ها</h6>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="100px">
                                                            <?php if (!empty($slider['image'])): ?>
                                                                <a data-url="<?= base_url() . $slider['image']; ?>"
                                                                   data-popup="lightbox">
                                                                    <img src=""
                                                                         data-src="<?= base_url() . $slider['image']; ?>"
                                                                         alt="<?= $slider['link']; ?>"
