    ...
    <div class="page-content">
        ...
        <div class="content-wrapper">
            ...
            <div class="page-header page-header-default"
                ...
                <div class="page-header-content border-bottom border-bottom-success">
                    <div class="page-title">
                        <h5>
                            <i class="icon-circle position-left"></i> <span class="text-semibold">ویرایش اسلاید</span>
                        </h5>
                    </div>
                </div>
            ...
            <div class="content">
                ...
                <div class="row">
                    <div class="col-md-9">
                        <form action="<?= base_url(); ?>admin/editSlider/<?= $param[0]; ?>" method="post">
                            <?= $data['form_token']; ?>
                                ...
                                <div class="col-md-12">
                                    <div class="panel panel-white">
                                        <div class="panel-heading">
                                            <h6 class="panel-title">مشخصات اسلاید</h6>
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="col-lg-12 mb-15">
                                                <div class="help-block alert alert-info no-border-right no-border-top no-border-bottom border-lg p-10">
                                                    ابعاد تصویر بهتر است به صورت
                                                    <span class="display-inline-block ltr">
                                                        <code>1837px * 329px</code>
                                                    </span>
                                                    باشد.
                                                </div>
                                                            ...
                                                            <div class="thumb">
                                                                <a class="display-inline-block"
                                                                   style="-webkit-box-shadow: 0 0 5px 1px rgba(0, 0, 0, 0.4);-moz-box-shadow: 0 0 5px 1px rgba(0, 0, 0, 0.4);box-shadow: 0 0 5px 1px rgba(0, 0, 0, 0.4);">
                                                                    <img src="<?= set_value($sldVals['image'] ?? '', '', base_url($sldVals['image'] ?? ''), asset_url('be/images/placeholder.jpg')); ?>"
                                                        ...
                                                        <div class="media-body">
                                                            <h6 class="media-heading">
                                                                ...
                                                                <a class="io-image-name display-block">
                                                                    <?= basename(set_value($sldVals['image'] ?? '')); ?>
                                                                </a>
                                                            </h6>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="form-group col-lg-8">
                                                ...
                                                <input name="link" type="text" class="form-control"
                                                       placeholder="http://example.com/category/digital-product"
                                                       value="<?= set_value($sldVals['link'] ?? ''); ?>">
                                            </div>
                                            <div class="form-group col-lg-2">
                                                <label>اولویت اسلاید:</label>
                                                <input name="priority" type="text" class="form-control"
                                                       placeholder="عدد وارد کنید"
                                                       value="<?= set_value($sldVals['priority'] ?? ''); ?>">
                                            </div>
                                            <div class="form-group col-lg-2 text-right">
                                                <label for="catStatus" class="mb-20">وضعیت نمایش:</label>
                                                <input type="checkbox" name="status" id="catStatus"
                                                       class="switchery" <?= set_value($sldVals['status'] ?? '', '1', 'checked', '', '=='); ?> />
                                            </div>
                                            <div class="text-right col-md-12">
                                                <a href="<?= base_url('admin/manageSlider'); ?>" class="btn btn-default mr-5">
                                                    بازگشت
                                                </a>
