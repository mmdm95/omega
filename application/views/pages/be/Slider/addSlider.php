    ...
    <div class="page-content">
        ...
        <div class="content-wrapper">
            ...
            <div class="page-header page-header-default"
                ...
                <div class="page-header-content border-bottom border-bottom-success">
                    <div class="page-title">
                        <h5>
                            <i class="icon-circle position-left"></i> <span class="text-semibold">افزودن اسلاید</span>
                        </h5>
                    </div>
                </div>
            ...
            <div class="content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <form action="<?= base_url(); ?>admin/addSlider" method="post">
                            <?= $data['form_token']; ?>
                                        ...
                                        <div class="panel-body">
                                                            ...
                                                            <div class="thumb">
                                                                <a class="display-inline-block"
                                                                   style="-webkit-box-shadow: 0 0 5px 1px rgba(0, 0, 0, 0.4);-moz-box-shadow: 0 0 5px 1px rgba(0, 0, 0, 0.4);box-shadow: 0 0 5px 1px rgba(0, 0, 0, 0.4);">
                                                                    <img
                                                                        src="<?= set_value($sldVals['image'] ?? '', '', base_url($gVals['image'] ?? ''), asset_url('be/images/placeholder.jpg')); ?>"
                                            ...
                                            <div class="form-group col-lg-2 text-right">
                                                ...
                                                <input type="checkbox" name="status" id="catStatus"
                                                       class="switchery" <?= set_value($sldVals['status'] ?? '', 'off', '', 'checked', '=='); ?> />
                                            </div>
