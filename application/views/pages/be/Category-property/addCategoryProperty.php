    ...
    <div class="page-content">
        ...
        <div class="content-wrapper">
            ...
            <div class="page-header page-header-default"
                    ...
                    <div class="page-title">
                        <h5>
                            <i class="icon-circle position-left"></i> <span
                                class="text-semibold">افزودن ویژگی به دسته‌بندی</span>
                        </h5>
                    </div>
                </div>
                ...
                <div class="breadcrumb-line">
                    <ul class="breadcrumb">
                        ...
                        <li class="active">افزودن ویژگی به دسته‌بندی</li>
                    </ul>
            ...
            <div class="content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <form action="<?= base_url(); ?>admin/addProperty" method="post">
                            <?= $data['form_token']; ?>
                                ...
                                <div class="col-md-9">
                                    <div class="panel panel-white">
                                        <div class="panel-heading">
                                            <h6 class="panel-title">مشخصات</h6>
                                                ...
                                                <select class="select-rtl" name="parent">
                                                    <?php foreach ($categories as $key => $category): ?>
                                                        <option value="<?= $category['id']; ?>"
                                                            <?= set_value($catVals['parent'] ?? '', $category['id'], 'selected', '', '=='); ?>>
