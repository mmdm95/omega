    ...
    <div class="page-content">
        ...
        <div class="content-wrapper">
            ...
            <div class="page-header page-header-default"
                    ...
                    <div class="page-title">
                        <h5>
                            <i class="icon-circle position-left"></i> <span
                                class="text-semibold">ویرایش ویژگی</span>
                        </h5>
                    </div>
                </div>
                ...
                <div class="breadcrumb-line">
                    <ul class="breadcrumb">
                        ...
                        <li class="active">ویرایش ویژگی</li>
                    </ul>
            ...
            <div class="content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <form action="<?= base_url(); ?>admin/editProperty/<?= $param[0]; ?>" method="post">
                            <?= $data['form_token']; ?>
                                ...
                                <div class="col-md-9">
                                    <div class="panel panel-white">
                                        <div class="panel-heading">
                                            <h6 class="panel-title">مشخصات ویژگی</h6>
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group col-lg-6">
                                                ...
                                                <input name="name" type="text" class="form-control"
                                                       placeholder="اجباری"
                                                       value="<?= set_value($propVals['property_name'] ?? ''); ?>">
                                            </div>
