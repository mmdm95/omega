            ...
            <div class="page-header page-header-default"
                ...
                <div class="page-header-content border-bottom border-bottom-success">
                    <div class="page-title">
                        <h5>
                            <i class="icon-circle position-left"></i> <span class="text-semibold">افزودن برند</span>
                        </h5>
                    </div>
                </div>
                ...
                <div class="breadcrumb-line">
                    <ul class="breadcrumb">
                        ...
                        <li class="active">افزودن برند</li>
                    </ul>
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group col-lg-6">
                                                ...
                                                <input name="brand" type="text" class="form-control"
                                                       placeholder="اجباری"
                                                       value="<?= set_value($brandVals['brand'] ?? ''); ?>">
                                            </div>
                                            <div class="form-group col-lg-6">
                                                ...
                                                <input name="keywords" type="text"
                                                       ...
                                                       data-role="tagsinput"
                                                       value="<?= set_value($brandVals['keywords'] ?? ''); ?>">
                                            </div>
                                            <div class="form-group col-md-12">
                                                ...
                                                <textarea class="form-control col-md-12 p-10"
                                                          ...
                                                          name="desc"
                                                          rows="4"
                                                          cols="10"><?= set_value($brandVals['desc'] ?? ''); ?></textarea>
                                            </div>
