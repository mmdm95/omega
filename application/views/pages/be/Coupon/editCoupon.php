    ...
    <div class="page-content">
        ...
        <div class="content-wrapper">
            ...
            <div class="content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <form action="<?= base_url(); ?>admin/editCoupon/<?= $param[0]; ?>" method="post">
                            <?= $data['form_token']; ?>
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group col-lg-5">
                                                ...
                                                <input type="text" class="form-control"
                                                       placeholder="قابل تغییر نیست!" disabled
                                                       value="<?= set_value($coVals['coupon_code'] ?? ''); ?>">
                                            </div>
                                            <div class="form-group col-lg-7">
                                                ...
                                                <input name="title" type="text" class="form-control"
                                                       placeholder="اجباری"
                                                       value="<?= set_value($coVals['coupon_title'] ?? ''); ?>">
                                            </div>
                                            <div class="form-group col-lg-7">
                                                <span class="text-danger">*</span>
                                                <label>قیمت:</label>
                                            ...
                                            <div class="form-group col-lg-4">
                                                ...
                                                <input type="text" class="form-control myAltDatepicker"
                                                       ...
                                                       value="<?= set_value(date('Y/m/d', $coVals['coupon_expire_time']) ?? '');; ?>">
                                            </div>
                                            <div class="form-group col-lg-12 text-right">
                                                <label for="coStatus">وضعیت فعالسازی:</label>
                                                <input type="checkbox" name="status" id="coStatus"
                                                       class="switchery" <?= set_value($coVals['status'] ?? '', 1, 'checked', '', '=='); ?> />
                                            </div>


                                            <div class="text-right col-md-12 mt-20">
                                                <a href="<?= base_url('admin/manageCoupon'); ?>" class="btn btn-default mr-5">
                                                    بازگشت
                                                </a>
