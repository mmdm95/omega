    ...
    <div class="page-content">
        ...
        <div class="content-wrapper">
            ...
            <div class="page-header page-header-default"
                    ...
                    <div class="page-title">
                        <h5>
                            <i class="icon-circle position-left"></i> <span
                                class="text-semibold">افزودن رنگ</span>
                        </h5>
                    </div>
                </div>
                ...
                <div class="breadcrumb-line">
                    <ul class="breadcrumb">
                        ...
                        <li class="active">افزودن رنگ جدید</li>
                    </ul>
            ...
            <div class="content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <form action="<?= base_url(); ?>admin/addColor" method="post">
                            <?= $data['form_token']; ?>
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group col-lg-6">
                                                ...
                                                <input name="hex" type="text" class="form-control color-picker"
                                                       ...
                                                       data-color="<?= set_value($colVals['hex'] ?? ''); ?>">
                                            </div>
