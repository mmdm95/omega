    ...
    <div class="page-content">
        ...
        <div class="content-wrapper">
            ...
            <div class="page-header page-header-default"
                    ...
                    <div class="page-title">
                        <h5>
                            <i class="icon-circle position-left"></i> <span
                                class="text-semibold">افزودن جشنواره</span>
                        </h5>
                    </div>
                </div>
                ...
                <div class="breadcrumb-line">
                    <ul class="breadcrumb">
                        ...
                        <li class="active">افزودن جشنواره جدید</li>
                    </ul>
            ...
            <div class="content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <form action="<?= base_url(); ?>admin/addFestival" method="post">
                            <?= $data['form_token']; ?>
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group col-lg-12 text-right mt-20">
                                                ...
                                                <input type="checkbox" name="status" id="catStatus"
                                                       class="switchery" <?= set_value($fesVals['status'] ?? '', 'off', '', 'checked', '=='); ?> />
                                            </div>
